...
from shaigan_hr.shaigan_hr.overrides.override_employee_checkin import (calculate_working_hours, mark_attendance_and_link_log)
...
class OverrideShiftType(ShiftType):
	...
	def get_attendance(self, logs , employee, attendance_date):
		...
		total_working_hours, in_time, out_time = calculate_working_hours(
			logs, employee, attendance_date, self, self.determine_check_in_and_check_out, self.working_hours_calculation_based_on
		)
		if (
